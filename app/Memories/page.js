  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="text-center mb-10">
        <h1 className="text-4xl font-semibold text-gray-900 dark:text-gray-200 leading-tight">Memories, Community & Blogs</h1>
        <p className="text-xl text-gray-600 mt-3 max-w-2xl mx-auto dark:text-gray-300">Share your precious stories, save your personal memories, and connect with a supportive community.</p>
        <Button
          onClick={() => {
      ...
      {(isAddingMemory || editingMemory) && (
        <Card className="bg-pink-100 dark:bg-gray-700 border-2 border-pink-200 p-6 shadow-xl rounded-xl">
          ...
          <CardContent className="space-y-6 p-0">
            ...
            <div>
              <label htmlFor="file-upload" className="block text-sm font-semibold mb-2 text-gray-700 dark:text-gray-200 ">
                Upload Media
              </label>
              <div className="flex items-center gap-4">
                ...
                <label
                  htmlFor="file-upload"
                  className="flex items-center gap-2 px-5 py-2.5 border border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50 text-gray-700 dark:text-gray-200 dark:hover:bg-gray-600 transition-colors">
            ...
            <div>
              <label htmlFor="tags" className="block text-sm font-semibold mb-2 text-gray-700 dark:text-gray-200">
              ...
              {publicMemories.map((memory) => (
                <div
                  ...
                  <div className="aspect-square bg-gray-100 relative">
                    {memory.file ? (
                      memory.type === "video" ? (
                        <video src={memory.file} className="w-full h-full object-cover" muted preload="metadata" />
                      ) : (
                    ...
                    <div className="flex items-center justify-between text-sm text-gray-500 border-t pt-3 mt-3 border-gray-100">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <button
                          ...
                          <Heart className="w-4 h-4" fill={memory.likes?.includes(memory._id) ? "currentColor" : "none"} />
