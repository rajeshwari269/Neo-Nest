...
const NotificationDemo = () => {
  ...
  return (
    <div className="bg-white rounded-xl dark:bg-gray-800 shadow-sm border  dark:border-gray-700  border-gray-200 p-6">
      <div className="flex items-center gap-3 mb-6">
        <div className="p-3 bg-pink-100 dark:bg-pink-900/30 rounded-full">
          <Bell className="text-pink-600 dark:text-pink-400" size={24} />
        </div>
        <div>
          <h2 className="text-xl dark:text-gray-100 font-bold text-gray-900">Notification Demo</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {demoNotifications.map((notification) => {
          ...
          return (
            <div key={notification.type} className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 hover:shadow-md transition-shadow bg-white dark:bg-gray-800">
              ...
              <p className="text-sm text-gray-600 mb-4 dark:text-gray-300">{notification.description}</p>
