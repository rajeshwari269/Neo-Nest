...
export default function LoginPrompt({ sectionName = "this section" }) {
  ...
  return (
    <div className="login-prompt-container  dark:bg-gray-900/90">
      <div className="w-full max-w-md animate-fade-in  ">
        <div className="login-prompt-card dark:bg-gray-800/90 bg-white">
          {/* Header */}
          ...
          <div className="space-y-4 mb-8">
            <div className="flex items-center gap-3 text-sm text-gray-600 group">
              ...
              <span className="group-hover:text-gray-700 dark:text-gray-200 transition-colors duration-300">Track growth and milestones</span>
            </div>
            <div className="flex items-center gap-3 text-sm text-gray-600 group">
              <Heart className="w-4 h-4 text-purple-500 group-hover:text-purple-600 transition-colors duration-300" />
              <span className="group-hover:text-gray-700 dark:text-gray-200 transition-colors duration-300">Store precious memories</span>
            </div>
          </div>
            ...
            <Button
              ...
              className={`w-full py-3 rounded-xl font-semibold shadow-md transition-all duration-300 transform ${
                isNavigating
                  ...
                  : "bg-gradient-to-r from-pink-400 to-purple-500 hover:from-pink-500 hover:to-purple-600 text-white hover:scale-[1.02] active:scale-[0.98] hover:shadow-lg hover:shadow-pink-200 dark:hover:shadow-pink-900"
              }`}>
              {isNavigating ? (
